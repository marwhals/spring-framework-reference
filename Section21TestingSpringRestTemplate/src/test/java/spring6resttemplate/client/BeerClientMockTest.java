package spring6resttemplate.client;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import spring6resttemplate.config.RestTemplateBuilderConfig;
import spring6resttemplate.model.BeerDTO;
import spring6resttemplate.model.BeerDTOPageImpl;
import spring6resttemplate.model.BeerStyle;
...
public class BeerClientMockTest {
    ...
    void setUp() throws JsonProcessingException {
        ...
        server = MockRestServiceServer.bindTo(restTemplate).build(); //Setting up the mock
        when(mockRestTemplateBuilder.build()).thenReturn(restTemplate); //Specifiying the behaviour
        beerClient = new BeerClientImpl(mockRestTemplateBuilder); //Setting up the mock
        dto = getBeerDto();
